...
public class WordsProvider extends ContentProvider {
    ...
    WordsDatabaseHelper mDbHelper = null;
    SQLiteDatabase db = null;
    public static final String AUTOHORITY = "com.hhu.ireciteword";
    ...
    static{
        ...
        // 初始化
        mMatcher.addURI(AUTOHORITY,"Note", Note_Code);
        mMatcher.addURI(AUTOHORITY,"Test", Test_Code);
